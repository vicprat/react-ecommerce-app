        ...
        <div className='container flex flex-wrap items-center justify-between mx-auto'>
          ...
          <div className='hidden w-full md:block md:w-auto' id='navbar-solid-bg'>
            <ul className='flex flex-col mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent'>
              <li>
                <a href='/shop' className='block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-white' aria-current='page'>Home</a>
              </li>
              <li>
